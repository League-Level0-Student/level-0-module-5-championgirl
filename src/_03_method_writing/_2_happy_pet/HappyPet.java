...
public class HappyPet {
   ...
   if(task==0) {
	...
	static void GiveFood(String pet) {
...
if( pet.contentEquals("Snake")){
	...
	JOptionPane.showMessageDialog(null," I feel Ssssimply SsssThe bestssssssssssssss");
...
if( pet.contentEquals("Red Panda")){
	...
	JOptionPane.showMessageDialog(null,"I'M ENDANGERED YOU ARE NOT ALLOWED TO KEEP ME AS A PET!!!!! Other than that I feel GREAT! :D");
...
if( pet.contentEquals(" ")){
	...
	JOptionPane.showMessageDialog(null,"We do not have that animal yet please choose another pet.");
